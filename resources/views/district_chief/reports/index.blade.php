@extends('layouts.app')
@section('title', 'Daftar Laporan — Kecamatan ' . $districtName)
...
<div class="bg-gray-10 min-h-[calc(100vh-68px)] py-16">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 pt-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-5">
            ...
            <form method="GET" action="{{ route('district-chief.reports.index') }}">
                ...
                <div class="flex items-center justify-between">
                    <p class="text-xs text-gray-500">
                        Hasil: <span class="font-semibold text-gray-900">{{ $reports->total() }}</span> laporan
                    </p>
        ...
        <div class="flex flex-col gap-3 mb-5">
            ...
            $officerNames = $report->assignments->take(2)
                ->map(fn ($a) => $a->employee?->user?->name)->filter()->implode(', ');
            ...
            {{-- Kartu laporan — klik judul → reports.show (public/shared) --}}
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                <div class="flex">
                    ...
                    <div class="flex-1 min-w-0 p-4">
                        ...
                        {{-- Baris 4: Petugas (read-only, no action buttons) --}}
                        <div class="flex items-center justify-between gap-2">
                            ...
                            {{-- Link detail (read-only, no assign button) --}}
                            <a href="{{ route('reports.show', $report->code) }}"
