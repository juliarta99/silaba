...
<body class="font-sans bg-[#F8F9FA]">
    ...
    <div class="w-full bg-[#F8F9FA] pb-16">
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            ...
            <h2 class="text-xl font-bold text-[#171717] mb-6">Katalog Reward</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @php
                    $items = [
                        [
                            'title' => 'Voucher Pulsa Rp 25.000', 
                            'cat' => 'Pulsa & Data', 
                            'desc' => 'Voucher pulsa untuk semua operator (Telkomsel, XL, Indosat, Tri)', 
                            'point' => '50', 'stok' => '100', 'icon' => 'kado', 'disabled' => false,
                            'gambar' => 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?q=80&w=500&auto=format&fit=crop'
                        ],
                        [
                            'title' => 'Voucher Belanja Rp 50.000', 
                            'cat' => 'Voucher', 
                            'desc' => 'Berlaku di Indomaret, Alfamart, Circle K', 
                            'point' => '100', 'stok' => '50', 'icon' => 'belanja', 'disabled' => false,
                            'gambar' => 'https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=500&auto=format&fit=crop'
                        ],
                        [
                            'title' => 'Voucher Kopi Rp 25.000', 
                            'cat' => 'F&B', 
                            'desc' => 'Nikmati kopi di kedai lokal Bali pilihan', 
                            'point' => '50', 'stok' => '75', 'icon' => 'kopi', 'disabled' => false,
                            'gambar' => 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=500&auto=format&fit=crop'
                        ],
                        [
                            'title' => 'Tiket Garuda Wisnu Kencana', 
                            'cat' => 'Wisata', 
                            'desc' => 'Tiket masuk gratis ke GWK Cultural Park', 
                            'point' => '150', 'stok' => '20', 'icon' => 'voucher', 'disabled' => false,
                            'gambar' => 'https://images.unsplash.com/photo-1604999333679-b86d54738315?q=80&w=500&auto=format&fit=crop'
                        ],
                        [
                            'title' => 'Merchandise SILABA', 
                            'cat' => 'Merchandise', 
                            'desc' => 'Kaos, topi, atau tote bag eksklusif SILABA', 
                            'point' => '75', 'stok' => '50', 'icon' => 'kado', 'disabled' => false,
                            'gambar' => 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?q=80&w=500&auto=format&fit=crop'
                        ],
                        [
                            'title' => 'Voucher Makan Rp 100.000', 
                            'cat' => 'F&B', 
                            'desc' => 'Berlaku di warung dan restoran lokal partner', 
                            'point' => '200', 'stok' => '25', 'icon' => 'kopi', 'disabled' => false,
                            'gambar' => 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?q=80&w=500&auto=format&fit=crop'
                        ],
                        [
                            'title' => 'Sertifikat Penghargaan', 
                            'cat' => 'Penghargaan', 
                            'desc' => 'Sertifikat Warga Peduli dari Pemkab Badung', 
                            'point' => '125', 'stok' => '200', 'icon' => 'sertifikat', 'disabled' => false,
                            'gambar' => 'https://images.pexels.com/photos/6532375/pexels-photo-6532375.jpeg'
                        ],
                        [
                            'title' => 'Tiket Taman Budaya Bali', 
                            'cat' => 'Wisata', 
                            'desc' => 'Tiket masuk gratis untuk 2 orang', 
                            'point' => '100', 'stok' => '15', 'icon' => 'voucher', 'disabled' => false,
                            'gambar' => 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?q=80&w=500&auto=format&fit=crop'
                        ],
                        [
                            'title' => 'Voucher Parkir Gratis', 
                            'cat' => 'Transportasi', 
                            'desc' => 'Voucher parkir 10x gratis di area publik Badung', 
                            'point' => '75', 'stok' => '40', 'icon' => 'voucher', 'disabled' => false,
                            'gambar' => 'https://images.unsplash.com/photo-1506521781263-d8422e82f27a?q=80&w=500&auto=format&fit=crop'
                        ],
                        
                        // ITEM DISABLED / TIDAK TERSEDIA (Layout disamakan, hanya diberi efek grayscale)
                        [
                            'title' => 'Diskon Pajak Kendaraan 10%', 
                            'cat' => 'Layanan Publik', 
                            'desc' => 'Potongan pajak kendaraan bermotor periode berikutnya', 
                            'point' => '300', 'stok' => '50', 'icon' => 'sertifikat', 'disabled' => true, 'btn' => 'Butuh 150 Poin Lagi',
                            'gambar' => 'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?q=80&w=500&auto=format&fit=crop'
                        ],
                        [
                            'title' => 'Voucher Spa Rp 150.000', 
                            'cat' => 'Wellness', 
                            'desc' => 'Relaksasi di spa dan massage center partner', 
                            'point' => '250', 'stok' => 'Habis', 'icon' => 'kado', 'disabled' => true, 'btn' => 'Tidak Tersedia',
                            'gambar' => 'https://images.unsplash.com/photo-1540555700478-4be289fbecef?q=80&w=500&auto=format&fit=crop'
                        ],
                        [
                            'title' => 'Paket Data 10GB', 
                            'cat' => 'Pulsa & Data', 
                            'desc' => 'Paket internet 10GB untuk semua provider', 
                            'point' => '100', 'stok' => 'Habis', 'icon' => 'kado', 'disabled' => true, 'btn' => 'Tidak Tersedia',
                            'gambar' => 'https://images.unsplash.com/photo-1562408590-e32931084e23?q=80&w=500&auto=format&fit=crop'
                        ],
                    ];
                @endphp
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm flex flex-col">
                    ...
                    <div class="relative flex flex-col items-center justify-center py-6 border-b border-gray-100 bg-cover bg-center bg-no-repeat overflow-hidden {{ $item['disabled'] ? 'grayscale' : '' }}" style="background-image: url('{{ $item['gambar'] }}');">
                        ...
                        <div class="relative z-10 flex flex-col items-center">
                            @if($item['icon'] == 'kado')
                                <svg width="56" height="56" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M46.3283 32.9957V42.3278C46.3283 43.035 46.0474 43.7132 45.5473 44.2132H30.3304C28.445 44.2132 27.6641 43.035 27.6641 42.3278V32.9957" stroke="#C01818" stroke-width="2.66632" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <span class="text-[10px] font-bold uppercase tracking-wider mt-2 text-[#6B7280]">{{ $item['cat'] }}</span>
                        </div>
                    </div>

                    {{-- Bagian Bawah Card (Detail Teks & Informasi Akurat) --}}
                    <div class="p-5 flex-grow flex flex-col justify-between">
                        <div>
                            
                            <h3 class="text-base font-bold mb-1 text-[#171717]">
                                {{ $item['title'] }}
                            </h3>

                            <p class="text-xs leading-relaxed mb-4 text-[#6B7280]">
                                {{ $item['desc'] }}
                            </p>
                        </div>
                        <div>
                            <div class="flex justify-between items-end mb-4">
                                <div>
                                    {{-- Angka Poin menggunakan #C01818 (Merah Pekat) --}}
                                    <span class="block text-2xl font-extrabold text-[#C01818]">
                                        {{ $item['point'] }}
                                    </span>
                                    {{-- Tulisan Poin kecil menggunakan #6B7280 --}}
                                    <span class="text-[10px] font-bold uppercase tracking-widest text-[#6B7280]">
                                        Poin
                                    </span>
                                </div>
                                <span class="text-[11px] font-bold px-2 py-0.5 rounded {{ $item['stok'] == 'Habis' ? 'text-red-600 bg-red-50' : 'text-emerald-600 bg-emerald-50' }}">
                                    Stok: {{ $item['stok'] }}
                                </span>
                            </div>
                            ...
                            @else
                                <button class="w-full py-2.5 bg-[#C01818] hover:bg-[#A01414] text-white text-xs font-bold rounded-lg transition-colors shadow-sm">Klaim Sekarang</button>
                            @endif
                        </div>
                    </div>
                </div>
