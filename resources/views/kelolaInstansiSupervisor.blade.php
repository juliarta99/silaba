        ...
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div class="px-6 py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <button type="button" class="px-5 py-2.5 bg-primary-700 hover:bg-primary-900 text-white text-sm font-bold rounded-lg transition-colors flex items-center justify-center gap-2 shadow-sm">
