...
<div class="min-h-[calc(100vh-68px)] flex flex-col items-center justify-center py-36 px-4 sm:px-6 lg:px-8 bg-gray-10">
    ...
    <div class="text-center mb-8">
        <a href="{{ route('home') }}" aria-label="SILABA" class="inline-block mb-5">
        ...
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Masuk ke SILABA</h2>
